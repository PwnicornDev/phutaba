...
sub do_spans {
    ...
    return join "<br />", map {
		...
		my %smilies = (
			...
			'eisfee'					=> '/img/emotes/eisfee.gif',
			'fffuuuuu'					=> '/img/emotes/fu.png',
			'fu'						=> '/img/emotes/fu.png',
			'awesome'					=> '/img/emotes/awesome.png',
			'\153\165\150\154\147\145\163\151\143\150\164' => '/img/emotes/schreikopf.png',
			'\120\105\116\111\123'		=> '/img/emotes/blau.png',
			'\126\101\107\111\116\101'	=> '/img/emotes/rot.png',
			'\150\145\170\145'			=> '/img/emotes/marisa.png'
		);
